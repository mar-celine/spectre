...
AlfvenWave::AlfvenWave(
  ...
  magnitude_B0_ =
      magnitude(initial_unit_vector_along_bkgd_magnetic_field_).get();
  magnitude_B1_ =
  ...
  for (size_t d = 0; d < 3; d++) {
    initial_unit_vector_along_bkgd_magnetic_field_.get(d) /= magnitude_B0_;
  ...
  ASSERT(equal_within_roundoff(
             dot_product(initial_unit_vector_along_bkgd_magnetic_field_,
...
void AlfvenWave::pup(PUP::er& p) noexcept {
  ...
  p | adiabatic_index_;
  p | bkgd_magnetic_field_;
  p | wave_magnetic_field_;
  p | alfven_speed_;
  p | fluid_speed_;
  p | initial_unit_vector_along_bkgd_magnetic_field_;
...
DataType AlfvenWave::k_dot_x_minus_vt(const tnsr::I<DataType, 3>& x,
  ...
  for (size_t d = 0; d < 3; d++) {
    result += wavenumber_ * x.get(d) *
              initial_unit_vector_along_bkgd_magnetic_field_.get(d);
  }
  return result;
}
...
bool operator==(const AlfvenWave& lhs, const AlfvenWave& rhs) noexcept {
  ...
  return lhs.wavenumber_ == rhs.wavenumber_ and
         ...
         lhs.bkgd_magnetic_field_ == rhs.bkgd_magnetic_field_ and
         ...
         lhs.background_spacetime_ == rhs.background_spacetime_ and
         lhs.initial_unit_vector_along_bkgd_magnetic_field_ ==
             rhs.initial_unit_vector_along_bkgd_magnetic_field_ and
         ...
         lhs.initial_unit_vector_along_wave_electric_field_ ==
             rhs.initial_unit_vector_along_wave_electric_field_;
}
